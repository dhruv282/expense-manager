...
const String amountTextFormFieldLabel = 'Amount \$';
const String descriptionTextFormFieldLabel = 'Description';
const String categoryTextFormFieldLabel = 'Category';
const String dateTextFormFieldLabel = 'Date';
const String personTextFormFieldLabel = 'Person';
